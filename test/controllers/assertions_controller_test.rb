...
class AssertionsControllerTest < ActionController::TestCase
  ...
  test "should create assertion" do
    assert_difference('Assertion.count') do
      post :create, assertion: { expected_value: @assertion.expected_value, field: @assertion.field, test_case_id: @assertion.test_case_id }
    end
  ...
  test "should update assertion" do
    patch :update, id: @assertion, assertion: { expected_value: @assertion.expected_value, field: @assertion.field, test_case_id: @assertion.test_case_id }
    assert_redirected_to assertion_path(assigns(:assertion))
  end
